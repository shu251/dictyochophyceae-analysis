...
Plan to subset MAGs based on the fact that they were assigned Dictyochophyte class, but lower than the default EUKulele settings, and they had >40% compelteness. We will come back to evaluate the ASV assignment here. 
```{r}
# Number that overlap
...
```{r Plot only the highest rsquared and occurence, fig.height=5, fig.width=8}
